...
$(document).ready(function(){
    ...
    imgMain=new Image();
    imgMain.src="simple RPG/image/spriteSheet.png";
    currentImgMainX= 0;
    currentImgMainY= 0;
    ...
    imgMountain.src= "image/material.png";
    imgEnemy=new Image();
...
$(document).keydown(function(event){
    ...
    switch(event.which){
        case 37:
            ...
            cutImgePositionX=175;
            break;
        case 38:
            targetImgMainX=currentImgMainX;
            targetImgMainY=currentImgMainY-200;
            cutImgePositionX=355;
            break;
        case 39:
            targetImgMainX=currentImgMainX+200;
            targetImgMainY=currentImgMainY;
            cutImgePositionX=540;
            break;
        case 40:
             targetImgMainX=currentImgMainX;
    ...
    ctx.drawImage(imgMain,cutImgePositionX,0,80,130,currentImgMainX,currentImgMainY,200,200);
